...
\book {
  ...
  %       \new StaffGroup <<
  %         \new GrandStaff <<
  %           \set GrandStaff.instrumentName = \transposedName "Clarinetto" "C" ""
  %           \new Staff {
  ...
  %       \new StaffGroup <<
  %         \new GrandStaff <<
  %           \set GrandStaff.instrumentName = "cl"
  %           \new Staff {
  ...
  %           % \transpose c f,
  %           \partCombine #'(0 . 10) \SanctaCornoI \SanctaCornoII
  %         >>
  %       >>
  %       \new StaffGroup <<
  %         \new GrandStaff \with { \smallGroupDistance } <<
  ...
  %           % \transpose c es,
  %           \partCombine #'(0 . 10) \SalusCornoI \SalusCornoII
  %         >>
  %       >>
  %       \new StaffGroup <<
  %         \new GrandStaff \with { \smallGroupDistance } <<
